...
import contentCookerGif from '~/assets/images/eui-content-cooker.gif';
import contentCookerTableGif from '~/assets/images/eui-content-cooker-table.gif';
...
<figure class="w-full max-w-5xl mb-8">
  <img src={contentCookerGif.src} alt="EUI Content Cooker interaction demo" class="w-full rounded-lg" />
  <figcaption class="mt-2 text-sm text-muted text-center">Adding realistic content to mockups from generators built with ChatGPT.</figcaption>
</figure>

<figure class="w-full max-w-5xl mb-8">
  <img src={contentCookerTableGif.src} alt="EUI Content Cooker interaction demo" class="w-full rounded-lg" />
  <figcaption class="mt-2 text-sm text-muted text-center">Manipulating table content with EUI Content Cooker.</figcaption>
</figure>
