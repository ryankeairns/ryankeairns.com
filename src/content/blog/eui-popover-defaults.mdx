...
tags: ["PR", "EUI", "Testing", "AI workflow"]
status: "PR"
role: "Principal Designer (IC)"
impact: "Improved consistency and design of a core EUI interaction pattern"
...
<figure class="w-full mb-8">
  ...
  <figcaption class="mt-2 text-sm text-muted text-center">Current EUI popover with arrow and related bug.</figcaption>
</figure>
